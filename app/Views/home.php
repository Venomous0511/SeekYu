    ...
    <header class="absolute inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between p-6 lg:px-8">
            <div class="flex lg:flex-1">
                <a href="<?= BASE_URL ?>/" class="text-2xl font-bold text-white hover:text-indigo-400">Seekyu</a>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end gap-x-6">
                <a href="<?= BASE_URL ?>/login" class="text-sm font-semibold text-white hover:text-indigo-400">Log in →</a>
            </div>
        </nav>
    </header>
        ...
        <section id="home" class="section flex items-center justify-center min-h-screen text-center">
            <div class="max-w-2xl">
                ...
                <div class="mt-10 flex justify-center items-center gap-x-6">
                    <a href="<?= BASE_URL ?>/login" class="rounded-md bg-indigo-500 px-4 py-2 text-white font-semibold hover:bg-indigo-400">Get started</a>
